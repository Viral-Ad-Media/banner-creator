...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "relative rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed group overflow-hidden";
